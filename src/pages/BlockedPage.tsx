        ...
        <div className="card mt-4 overflow-hidden">
          <table className="min-w-full text-[13px]">
            <thead className="border-b border-line bg-bg-input text-left text-[11px] font-semibold uppercase tracking-wider text-text-muted">
              <tr>
                <th className="px-4 py-3">{t("blocked.col.user")}</th>
                <th className="px-4 py-3">{t("users.col.phone")}</th>
                <th className="px-4 py-3">{t("blocked.col.blockedDate")}</th>
              ...
              {filtered.map((u) => (
                <tr key={u.id} className="border-b border-line/50 hover:bg-bg-hover">
                  ...
                  <td className="px-4 py-3 text-right">
                    ...
                    >
                      <UserCheck className="h-3.5 w-3.5" /> {t("blocked.unblockButton")}
                    </button>
                  </td>
                </tr>
              ))}

...
export function productToUi(p: AdminStoreProduct): UiProduct {
  ...
  return {
    ...
    name: {
      uz: p.name || "",
      uz_cyrl: (raw as { name_uz_cyrl?: string }).name_uz_cyrl || "",
      ru: raw.name_ru || "",
      en: raw.name_en || "",
    },
    description: {
      uz: raw.description || "",
      uz_cyrl: (raw as { description_uz_cyrl?: string }).description_uz_cyrl || "",
      ru: raw.description_ru || "",
      en: raw.description_en || "",
    },
    shortDescription: {
      uz: raw.short_description || "",
      uz_cyrl: (raw as { short_description_uz_cyrl?: string }).short_description_uz_cyrl || "",
      ru: raw.short_description_ru || "",
      en: raw.short_description_en || "",
    },
    categoryLabel: {
      uz: raw.category_label || p.product_type || "",
      uz_cyrl: (raw as { category_label_uz_cyrl?: string }).category_label_uz_cyrl || "",
